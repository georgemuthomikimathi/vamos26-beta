...
export const TOP_ASSISTS: StatLeader[] = [
  ...
  { rank: 2, name: "Kevin De Bruyne", country: "Belgium", code: "be", club: "Man City", value: 0 },
...
export const CLEAN_SHEETS: StatLeader[] = [
  ...
  { rank: 2, name: "Gianluigi Donnarumma", country: "Italy", code: "it", club: "PSG", value: 0, detail: "GK" },
